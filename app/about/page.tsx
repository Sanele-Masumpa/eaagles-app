  ...
  return (
    <div className="max-w-full px-6 py-8 mx-auto">
      ...
      <section className="mb-12">
        ...
        <div className="flex flex-col gap-8 md:flex-row">
          <div className="md:w-1/2 mb-6">
            ...
            <a href="/about#vision" className="hover:underline text-primary font-semibold">
          ...
          <div className="md:w-1/2 mb-6">
            ...
            <p className="text-lg mb-4">
              Eagles Ring simplifies the investment process by providing a comprehensive suite of tools for entrepreneurs to pitch their ideas 
              and for investors to evaluate opportunities. Our platform supports detailed profiles, secure transactions, and effective communication channels.
            </p>
            <a href="/about#how-it-works" className="hover:underline text-primary font-semibold">
      ...
      <section className="mb-12">
        ...
        <p className="text-lg mb-6">
          Meet the talented team behind Eagles Ring. Our diverse team brings together experts in technology, finance, and business development 
          to ensure the platform's success and innovation.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="border rounded-lg shadow-lg p-6">
            ...
            <a href="https://linkedin.com/in/johndoe" className="hover:underline text-primary font-semibold" target="_blank" rel="noopener noreferrer">
              Connect with John
            </a>
          </div>
          ...
          <div className="border rounded-lg shadow-lg p-6">
            ...
            <a href="https://linkedin.com/in/janesmith" className="hover:underline text-primary font-semibold" target="_blank" rel="noopener noreferrer">
              Connect with Jane
            </a>
          </div>
          ...
          <div className="border rounded-lg shadow-lg p-6">
            ...
            <a href="https://linkedin.com/in/emilyjohnson" className="hover:underline text-primary font-semibold" target="_blank" rel="noopener noreferrer">
              Connect with Emily
            </a>
          </div>
        </div>
      ...
      <section className="mb-12">
        ...
        <p className="text-lg mb-6">
          We are proud of the milestones we have achieved since launching Eagles Ring. Our platform has successfully facilitated numerous investments 
        ...
        <a href="/about#achievements" className="hover:underline text-primary font-semibold">
