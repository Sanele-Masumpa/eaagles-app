...
const NotFoundPage = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen text-center p-6 bg-gray-100 dark:bg-gray-900 text-black dark:text-white">
      ...
      <p className="text-lg mb-6">
        <span role="img" aria-label="confused">🤔</span> <span className="text-gray-600 dark:text-gray-400">Sicela, uzame le page ebheke lapho!</span>
      </p>
      <Link href="/">
        <a className="bg-gold text-black dark:text-white py-2 px-4 rounded hover:bg-yellow-600 dark:hover:bg-yellow-500 transition">
          Go Back to Home
        </a>
      </Link>
    </div>
